...
public class DigerUygulamalar extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        questionList.add(new Question(R.drawable.ehliyet2017,"Ehliyet 2017","Ehliyet 2017 çıkmış sorular\n Ücretsiz"));
        ...
        questionList.add(new Question(R.drawable.ehliyetpro2017,"Ehliyet 2017 pro","Ehliyet 2017 çıkmış sorular\n Reklamsız"));
