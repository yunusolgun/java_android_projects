...
public class MainActivity extends AppCompatActivity
    ...
    public void paylas() {
        Intent shareIntent;
        String shareBody= "https://play.google.com/store/apps/details?id=com.robusttech.ehliyet";
        shareIntent = new Intent(android.content.Intent.ACTION_SEND);
        shareIntent.setType("text/plain");
        shareIntent.putExtra(Intent.EXTRA_SUBJECT,"Çıkmış Ehliyet soruları. Sınavı geçebilir misin?");
    ...
    public void satinAl() {
        Uri uri = Uri.parse("market://details?id=com.robusttech.ehliyetpro");
        ...
        try {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("http://play.google.com/store/apps/details?id=market://details?id=com.robusttech.ehliyetpro")));
        }
    }
